        ...
        <div className="max-w-6xl mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Start your morning right with a mug that brings a smile to your face.
              Our carefully designed mugs are more than just drinkware — they're
              daily companions that make every sip special.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 text-lg leading-relaxed">
                <p>
                  We believe that the little things in life matter. That first cup of
                  coffee in the morning, the afternoon tea break, the late-night hot
                  chocolate — these moments deserve something special.
                </p>
                <p>
                  That's why we created MuggButiken. Our mugs are designed to bring
                  joy to your daily routine. Each mug is crafted with care, featuring
                  cheerful designs that remind you to smile, even on the busiest days.
                </p>
                <p>
                  Because happiness shouldn't be complicated — sometimes it just takes
                  the right cup.
                </p>
              </div>
            </div>
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-xl p-6 max-w-xs">
                <div className="flex items-center gap-3 mb-2">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 rounded-full bg-red-200 flex items-center justify-center text-xs">☕</div>
                    <div className="w-8 h-8 rounded-full bg-red-300 flex items-center justify-center text-xs">❤️</div>
                    <div className="w-8 h-8 rounded-full bg-red-400 flex items-center justify-center text-xs">😊</div>
                  </div>
                  <span className="text-sm text-gray-500">Happy customers</span>
                </div>
                <p className="text-sm text-gray-600">"Best mug I've ever owned!"</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Made from high-quality ceramic that keeps your drinks at the perfect
                temperature and feels great in your hands.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Designed with Love</h3>
              <p className="text-gray-600 leading-relaxed">
                Every design is created to bring positivity to your day.
                Our cheerful mugs are guaranteed to make you smile.
              </p>
            </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Join thousands of happy customers who've made their mornings brighter
            with our mugs. Your perfect cup is waiting.
          </p>
          <Link
            href="/product/mugg"
